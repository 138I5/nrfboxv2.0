...
void (*menu_functions[NUM_ITEMS])() = {
  ...
  utils, Setting::settingSetup, Favorites::favSetup
};
...
void (*menu_loop_functions[NUM_ITEMS])() = {
  ...
  nullptr, Setting::settingLoop, Favorites::favLoop
};
